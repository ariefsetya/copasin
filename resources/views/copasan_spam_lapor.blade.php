...
@section('content')
<form id="form_post" method="POST" action="{{url('laporcops')}}">
<h1 class="wordw-div">Laporkan Copasan "<?php echo $data->judul;?>" sebagai spam</h1>
...
<table>
    ...
    <tr>
        <td></td>
        <td><button id="save" type="submit">Laporkan</button></td>
    </tr>
</table>
</form>
@endsection
